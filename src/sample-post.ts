...
C programming language and the legacy OpenGL 2.1 graphics library. We will be
using the <abbr title="OpenGL Utility Toolkit">GLUT</abbr> library to create a
window and handle user inputs.

![Some OpenGL source code](https://images.unsplash.com/photo-1615525137689-198778541af6 "Yes, I know, we won't be using shaders and GLFW!")
